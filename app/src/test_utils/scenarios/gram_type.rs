...
pub fn scenario_gram_type_schema() -> Scenario<NewGramTypeSchema> {
    Scenario {
        ...
        update: vec![
            NewGramTypeSchema::new(0, "noun_common edit", "Sustantivo comun edit"),
            NewGramTypeSchema::new(1, "noun_proper edit", "Nombre propio edit"),
            NewGramTypeSchema::new(2, "verb_main edit", "Verbo lexico edit"),
        ],
    }
}
