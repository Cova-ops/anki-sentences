    ...
    mod from_sql {
        ...
        fn ok_with_null_deleted_at() -> Result<(), DbError> {
            ...
            let mut stmt = conn.prepare(
                "SELECT 10, 'de->es', 3, 2.5, 7, '2025-12-04 20:00:00', '2025-12-10 20:00:00', '2025-12-04 20:00:00', NULL;",
            )?;

            let out: SchemaWortReview = stmt.query_one([], SchemaWortReview::from_sql)?;

            assert_eq!(out.wort_id, 10);
            assert_eq!(out.direction, "de->es");
        ...
        fn ok_with_some_deleted_at() -> Result<(), DbError> {
            ...
            let mut stmt = conn.prepare(
                "SELECT 11, 'es->de', 1, 2.3, 1, '2025-12-04 20:00:00', '2025-12-05 20:00:00', '2025-12-04 20:00:00', '2025-12-31 00:00:00';",
            )?;

            let out: SchemaWortReview = stmt.query_one([], SchemaWortReview::from_sql)?;

            assert_eq!(out.wort_id, 11);
            assert_eq!(out.direction, "es->de");
        ...
        fn err_type_mismatch() -> Result<(), DbError> {
            ...
            let mut stmt = conn.prepare("SELECT 10, 'de->es', 'oops', 2.5, 7, '2025-12-04 20:00:00', '2025-12-10 20:00:00', '2025-12-04 20:00:00', NULL;",)?;

            let out: Result<SchemaWortReview, _> = stmt.query_one([], SchemaWortReview::from_sql);
        ...
        fn err_missing_column() -> Result<(), DbError> {
            ...
            let mut stmt = conn.prepare("SELECT 10, 'de->es', 3, 2.5, 7, '2025-12-04 20:00:00', '2025-12-10 20:00:00', '2025-12-04 20:00:00';",)?;
