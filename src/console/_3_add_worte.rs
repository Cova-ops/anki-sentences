...
use crate::{
    db::{SetzeRepo, WorteRepo, schemas::worte::WorteSchema},
    helpers::{extract_sentences_csv, extract_worte_csv, is_csv_valid, ui},
...
pub fn menu_3_add_worte() -> Result<()> {
    // clean_screen();
    ...
    loop {
        ...
        let res = WorteRepo::bulk_insert(&new_data);
